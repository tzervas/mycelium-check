# Gap status — `mycelium-check`

| Field | Value |
|-------|--------|
| **Component** | `mycelium-check` |
| **Role** | myc-check driver |
| **Date** | 2026-07-29 |
...
| **Native twin** | `tzervas/mycelium-check-myc` under [mycelium-lang-myc](https://github.com/tzervas/mycelium-lang-myc) |
| **Local gap notes** | none |
| **Related issues** | Tooling — follows frontend/project model |
